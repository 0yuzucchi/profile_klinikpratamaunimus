...
// --- HELPER: Fungsi Format Tanggal (PENTING) ---
const formatDate = (dateString) => {
    if (!dateString) return '-';
    const date = new Date(dateString);
    
    // Jika formatnya sudah string Indonesia (fallback) atau invalid, kembalikan string aslinya
        ...
        <div className="bg-gray-50 p-5 md:p-6 rounded-lg mb-6 md:mb-8 border border-gray-100">
            ...
            <div className="relative">
                <input 
                    ...
                    className="w-full pl-4 pr-10 py-3 rounded border border-gray-300 focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500 text-sm shadow-sm"
                />
                <button onClick={handleSearch} className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-green-600">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                    </svg>
                </button>
